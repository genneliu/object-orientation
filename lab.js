...
let Gandalf = new Wizard("Gandalf", 24000, "lightning flash")
...
//Code Here
let phone1 = new Phone('Apple', 'X', 200, 'black', 1000);
let phone2 = new Phone('Samsung', 'S5', 200, 'blue', 700);
let phone3 = new Phone('LG', 'V20', 200, 'white', 599);
...
//Code Here
let myFirstVehicle = new Vehicle(5, "grey", 90000);
...
//Code Here 
myFirstMotorcycle = new Motorcycle("Honda", "Yes", 1, "red", 100)
...
class Boat extends Vehicle{
  constructor(name, type, isSeaWorthy, make, isCool, capacity, color, mileage) {
    super(make, isCool, capacity, color, mileage)
    this.name = name;
    this.type = type;
...
//Code Here
let myFirstBoat = new Boat('Odysseus', 'Saillboat', false, "Honda", "Yes", 10, "yellow", "300");
